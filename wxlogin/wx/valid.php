...
define("TOKEN", "tyx"); //自己定义的token 就是个通信的私钥
...
//                echo $str;
            ...
            $nameopenid=substr($openid,0,5);
            $sql = "UPDATE `user` SET `openid` = '" . $openid . "',`password` = '" . $openid . "',`rank` = '初级会员',nickname='" . $userinfo['nickname'] . "'"
                    . ",username='" . $userinfo['nickname'] . $nameopenid . "' WHERE `id` =" . $scene_id . "";
...
//https://www.zhihu.com/question/30074728
    public function getAccessToken() {
        ...
        $secret = 'e48cd311122b01ea03ac60fea64a274a';
